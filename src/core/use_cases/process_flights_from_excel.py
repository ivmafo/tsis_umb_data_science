...
from infraestructure.adapters.excel_flight_transformer import ExcelFlightTransformer
from domain.ports.flight_repository import FlightRepository
from domain.ports.file_processing_control_repository import FileRepository
from application.use_cases.create_flight import CreateFlightUseCase

class ProcessFlightsFromExcelUseCase:
    def __init__(self, flight_repository: FlightRepository, file_repository: FileRepository):
