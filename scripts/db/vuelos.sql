...
(
    ...
    origen character varying(50) COLLATE pg_catalog."default",
    fecha_salida date,
    ...
    distancia integer,
    velocidad integer,
    eq_ssr character varying(50) COLLATE pg_catalog."default",
